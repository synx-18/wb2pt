function darkmode() { // function to run when darkmode button is pressed
    ...
    var df = document.getElementsByClassName("imi"); // code for darkmode transition

    for( i = 0; i < d.length; i++) {
        df[i].style.transition = "all 0.25s"; // all elements with darkmode class, transition = 0.25s
    }
